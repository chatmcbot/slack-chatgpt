...
from app.env import (
    CONFIG_ENABLE_OPENAI_KEY,
    CONFIG_ENABLE_OPENAI_MODEL,
    OPENAI_API_KEY,
    SYSTEM_TEXT,
    MODEL_NAME_MAPPING,
    USE_SLACK_LANGUAGE,
            ...
            blocks.append(
                {
                    ...
                    "element": {
                        ...
                        "initial_option": {
                            "text": {
                                "type": "plain_text",
                                "text": MODEL_NAME_MAPPING[already_set_model]
                                if already_set_model
                                else MODEL_NAME_MAPPING["gpt-3.5-turbo"],
                            },
            ...
            blocks.append(
                {
                    ...
                    "element": {
                        "type": "plain_text_input",
                        "action_id": "input",
                        "initial_value": already_set_system_prompt or SYSTEM_TEXT,
                    },
                }
            )
